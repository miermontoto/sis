...
const VALID_KEYS = ['rankingMetric', 'rankChangeLookback', 'weekStart', 'locale', 'albumTrackDisplay', 'albumShowDuration', 'albumShowAccolades', 'lastPeriodWeek', 'lastPeriodMonth', 'lastPeriodYear'] as const;
